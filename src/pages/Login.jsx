...
function Login() {
  ...
  return (
    <div>
      <form className="w-1/4 mt-4 flex flex-col mx-auto rounded-md gap-5  p-5 bg-slate-100  hover:bg-stone-200 active:bg-stone-700 focus:outline-none focus:ring focus:ring-stone-300 border">
        <input
        ...
        />
        <button className="btn btn-ghost bg-slate-200" onClick={handleLogin}>
          Login
        </button>
      </form>
    </div>
